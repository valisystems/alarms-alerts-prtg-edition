...
class JAK_Paginator{
	...
	public function paginate()
	{
		...
		if($this->num_pages > 1) {
			...
			$this->return .= ($this->current_page != $this->num_pages And $this->items_total >= 2) ? '<li><a href="'.$this->jak_where.JAK_rewrite::jakParseurlpaginate($next_page).'">'.$this->jak_nexttext.'</a></li></ul>' : '</ul>';
		}
