...
<div class="col-md-12">
	...
	<a class="btn btn-primary" href="<?php echo $P_TICKET_N;?>"><i class="fa fa-ticket"></i> <?php echo $tlt["st"]["t36"];?></a>
	<?php } ?>
</div>
</div>
	...
	<div class="col-md-4 col-sm-6">
		<div class="service-wrapper">
			...
			<p><?php echo $v["contentshort"];?></p>
				...
				<hr><a href="<?php echo $v["parseurl"];?>" class="btn btn-primary"><?php echo $tl["general"]["g3"];?></a><?php if (JAK_ASACCESS) { ?> <a href="<?php echo BASE_URL;?>admin/index.php?p=ticketing&amp;sp=edit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g"];?>" class="btn btn-default jaktip"><i class="fa fa-pencil"></i></a> <a class="btn btn-default jaktip quickedit" href="<?php echo BASE_URL;?>admin/index.php?p=ticketing&amp;sp=quickedit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g176"];?>"><i class="fa fa-edit"></i></a><?php } ?>
				</p>
		</div>
	</div>
	<?php } ?>
