...
<hr>
<h3 class="text-color"><?php echo $tlt["st"]["t43"].JAK_PLUGIN_NAME_TICKETING;?></h3>
<div class="row">
	...
	<div class="col-md-4 col-sm-6">
		<div class="service-wrapper">
			...
			<p><?php echo $st["contentshort"];?></p>
				...
				<hr><a href="<?php echo $st["parseurl"];?>" class="btn btn-color btn-sm"><?php echo $tl["general"]["g3"];?></a><?php if (JAK_ASACCESS) { ?> <a href="<?php echo BASE_URL;?>admin/index.php?p=ticketing&amp;sp=edit&amp;id=<?php echo $st["id"];?>" title="<?php echo $tl["general"]["g"];?>" class="btn btn-default btn-sm jaktip"><i class="fa fa-pencil"></i></a> <a class="btn btn-default btn-sm jaktip quickedit" href="<?php echo BASE_URL;?>admin/index.php?p=ticketing&amp;sp=quickedit&amp;id=<?php echo $st["id"];?>" title="<?php echo $tl["general"]["g176"];?>"><i class="fa fa-edit"></i></a><?php } ?>
				</p>
		</div>
	</div>
	<?php } ?>
