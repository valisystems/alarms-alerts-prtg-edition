...
<div class="box box-default">
  ...
  <i class="fa fa-bars"></i>
	...
	<?php echo jak_build_menu_ticketing(0, $mheader, $tl["cat"]["al"], ' class="sortable jak_cat_move"', ' id="mheader"');?>
...
<i title="<?php echo $tlt["st"]["t1"];?>" class="fa fa-sticky-note-o"></i>
...
$(document).ready(function() {
	...
	$(".save-menu-plugin").on("click", function() {
		...
		var request = $.ajax({
		  url: "index.php?p=ticketing&amp;sp=categories",
		  type: "POST",
		  data: serialized,
		  dataType: "json",
		  cache: false
