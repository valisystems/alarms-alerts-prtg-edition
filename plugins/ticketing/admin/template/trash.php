...
<th><button type="submit" name="untrash" id="button_lock" class="btn btn-default btn-xs" onclick="if(!confirm('<?php echo $tlt["st"]["co"];?>'))return false;"><i class="fa fa-check"></i></button></th>
...
<i title="<?php echo $tl["icons"]["i18"];?>" class="fa fa-check"></i>
