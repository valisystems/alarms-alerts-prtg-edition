...
<th><?php echo $tld["dload"]["d8"];?> <a class="btn btn-warning btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=title&amp;sssp=DESC"><i class="fa fa-arrow-up"></i></a> <a class="btn btn-success btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=title&amp;sssp=ASC"><i class="fa fa-arrow-down"></i></a></th>
<th><?php echo $tl["page"]["p1"];?></th>
<th><?php echo $tl["page"]["p2"];?></th>
<th><?php echo $tl["general"]["g56"];?> <a class="btn btn-warning btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=hits&amp;sssp=DESC"><i class="fa fa-arrow-up"></i></a> <a class="btn btn-success btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=hits&amp;sssp=ASC"><i class="fa fa-arrow-down"></i></a></th>
<th><?php echo $tld["dload"]["d9"];?> <a class="btn btn-warning btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=countdl&amp;sssp=DESC"><i class="fa fa-arrow-up"></i></a> <a class="btn btn-success btn-xs" href="index.php?p=download&amp;sp=sort&amp;ssp=countdl&amp;sssp=ASC"><i class="fa fa-arrow-down"></i></a></th>
