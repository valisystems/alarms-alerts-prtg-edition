...
<tr>
	...
	<td><input type="text" name="jak_maxpost" class="form-control" value="<?php echo $jkv["blogmaxpost"];?>" /></td>
</tr>
<tr>
...
<tr>
	...
	<td><div class="radio"><label><input type="radio" name="jak_blogurl" value="1"<?php if ($jkv["blogurl"] == 1) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"];?></label></div>
	<div class="radio"><label><input type="radio" name="jak_blogurl" value="0"<?php if ($jkv["blogurl"] == 0) { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"];?></label></div></td>
</tr>
<tr>
...
<tr>
	...
	<td><div class="form-group<?php if (isset($errors["e5"])) echo " has-error";?>"><input type="text" name="jak_mid" class="form-control" value="<?php echo $jkv["blogpagemid"];?>" /></div></td>
</tr>
<tr>
	<td><?php echo $tl["setting"]["s12"];?></td>
	<td><div class="form-group<?php if (isset($errors["e5"])) echo " has-error";?>"><input type="text" name="jak_item" class="form-control" value="<?php echo $jkv["blogpageitem"];?>" /></div></td>
</tr>
</table>
</div>
	<div class="box-footer">
