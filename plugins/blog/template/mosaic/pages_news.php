	...
	<div class="jak-post">
		...
		<div class="post-info">
			<div class="info-details">
				<?php if ($bl["showdate"]) { ?><i class="fa fa-clock-o"></i> <?php echo $bl["created"];?><br><?php } ?><i class="fa fa-eye"></i> <?php echo $tl["general"]["g13"].$bl["hits"];?>
			</div>
		</div>
		<!-- End Post Info -->
		<!-- Post Image -->
		...
		<div class="post-more">
			...
			<?php if (JAK_ASACCESS) { ?>
				...
				<a class="btn btn-default btn-sm jaktip quickedit" href="<?php echo BASE_URL;?>admin/index.php?p=blog&amp;sp=quickedit&amp;id=<?php echo $bl["id"];?>" title="<?php echo $tl["general"]["g176"];?>"><i class="fa fa-edit"></i></a>
