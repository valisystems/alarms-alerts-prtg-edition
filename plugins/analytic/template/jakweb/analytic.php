...
<?php   
if ($PAGE_PASSWORD && !JAK_ASACCESS && $PAGE_PASSWORD != $_SESSION['pagesecurehashpasswordProtected'])   
{
    if ($errorpp){
        ?>
            <!-- Show password error -->
...
?>
    ...
    if ($g_data) {
        ...
        <script type="text/javascript" src="admin/chart/exporting.js"></script>
    ...
    $(document).ready(function() {
        ...
        if ($(".start_date"))
        {
            $(".start_date").daterangepicker(dateFormat, function(from, to, label){
				console.log(from.format("MMMM D, YYYY"));
    ...
    {
        $.get("/index.php/?p=analytic&sp=ajax&sssp=get", function (data) {
            if (data)
            {
    ...
    <div class="row">
        <div class="col-xs-3">
            <a href="/index.php?p=analytic&ssp=dev_rep"  class="btn btn-primary btn-lg btn-block">Device Report</a>
        </div>
        <div class="col-xs-3">
            <a href="/index.php?p=analytic&ssp=rep"  class="btn btn-primary btn-lg btn-block">Report</a>
        </div>
        <div class="col-xs-3">
            <a href="index.php?p=analytic&ssp=filter"  class="btn btn-primary btn-lg btn-block">Filter</a>
        </div>
    </div>
