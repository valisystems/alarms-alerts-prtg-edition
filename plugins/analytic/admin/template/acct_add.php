                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-group <?php if (isset($errors["e1"])) echo " has-error";?>"">
                                        <input type="text" name="domain" class="form-control" value="<?php if(isset($JAK_FORM_DATA["domain"])) echo $JAK_FORM_DATA["domain"];?>" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="form-group <?php if (isset($errors["e2"])) echo " has-error";?>"">
                                        <input type="text" name="account" class="form-control" value="<?php if(isset($JAK_FORM_DATA["account"])) echo $JAK_FORM_DATA["account"];?>" />
                                    </div>
                                </td>
                            </tr>
                            <tr>
