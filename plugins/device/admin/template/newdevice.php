                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group<?php if (isset($errors["e1"])) echo " has-error";?>">
                                                <input type="text" name="jak_device_id" class="form-control" value="<?php if(isset($_REQUEST["jak_device_id"])) echo $_REQUEST["jak_device_id"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                    	...
                                    	<td>
                                            <div class="form-group<?php if (isset($errors["e2"])) echo " has-error";?>">
                                                <input type="text" name="jak_base_name" class="form-control" value="<?php if(isset($_REQUEST["jak_base_name"])) echo $_REQUEST["jak_base_name"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group<?php if (isset($errors["e3"])) echo " has-error";?>">
                                                <input type="text" name="jak_device_type" class="form-control" value="<?php if(isset($_REQUEST["jak_device_type"])) echo $_REQUEST["jak_device_type"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group<?php if (isset($errors["e4"])) echo " has-error";?>">
                                                <input type="text" name="jak_event_type" class="form-control" value="<?php if(isset($_REQUEST["jak_event_type"])) echo $_REQUEST["jak_event_type"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" name="jak_antenna_int" class="form-control" value="<?php if(isset($_REQUEST["jak_antenna_int"])) echo $_REQUEST["jak_antenna_int"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" name="jak_pendant_rx_level" class="form-control" value="<?php if(isset($_REQUEST["jak_pendant_rx_level"])) echo $_REQUEST["jak_pendant_rx_level"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group<?php if (isset($errors["e7"])) echo " has-error";?>">
                                                <input type="text" name="jak_low_battery" class="form-control" value="<?php if(isset($_REQUEST["jak_low_battery"])) echo $_REQUEST["jak_low_battery"];?>" />
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group<?php if (isset($errors["e5"])) echo " has-error";?>">
                                                <input type="text" name="jak_time_stamp" class="form-control" value="<?php if(isset($_REQUEST["jak_time_stamp"])) echo $_REQUEST["jak_time_stamp"];?>" />
                                            </div>
                                        </td>
                                    </tr>
