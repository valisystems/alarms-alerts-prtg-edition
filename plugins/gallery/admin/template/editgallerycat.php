...
<tr>
	...
	<td><div class="form-group<?php if ($errors["e2"] || $errors["e3"]) echo " has-error";?>">
...
<tr>
	...
	<td><div class="radio"><label><input type="radio" name="jak_uploadc" value="1"<?php if ($JAK_FORM_DATA["uploadc"] == '1') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g18"];?></label></div>
	<div class="radio"><label><input type="radio" name="jak_uploadc" value="0"<?php if ($JAK_FORM_DATA["uploadc"] == '0') { ?> checked="checked"<?php } ?> /> <?php echo $tl["general"]["g19"];?></label></div></td>
</tr>
<tr>
