...
class Socket
{
	...
	public function __construct()
	{
        ...
        $this->FTP_BINARY = 1;
        $this->FTP_IMAGE = 1;
        $this->FTP_TIMEOUT_SEC = 60;

        $this->_NET_FTP['USE_PASSIVE'] = false;
        $this->_NET_FTP['DATA']        = null;
	}
     ...
     * @return   boolean
     */
    public function ftp_login(&$control, $username, $password)
    {
