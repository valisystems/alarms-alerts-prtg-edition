...
<div class="row">
	...
	<div class="col-md-6">
		...
		<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
			...
			<button type="submit" name="avatarR" class="btn btn-primary"><?php echo $tl["general"]["g10"];?></button>
			<hr>
			<h3><?php echo $tl["general"]["g181"];?></h3>
			<div class="row text-center">
				<div class="col-xs-2">
					<img src="../<?php echo JAK_FILES_DIRECTORY;?>/userfiles/standard.png" class="img-circle img-responsive" alt="standard avatar" />
				...
				<div class="col-xs-2">
					<img src="../<?php echo JAK_FILES_DIRECTORY;?>/userfiles/avatar.png" class="img-circle img-responsive" alt="avatar" />
				...
				<div class="col-xs-2">
					<img src="../<?php echo JAK_FILES_DIRECTORY;?>/userfiles/avatar2.png" class="img-circle img-responsive" alt="avatar2" />
				...
				<div class="col-xs-2">
					<img src="../<?php echo JAK_FILES_DIRECTORY;?>/userfiles/avatar3.png" class="img-circle img-responsive" alt="avatar3" />
				...
				<div class="col-xs-2">
					<img src="../<?php echo JAK_FILES_DIRECTORY;?>/userfiles/avatar4.png" class="img-circle img-responsive" alt="avatar4" />
			...
			<button type="submit" name="avatarS" class="btn btn-primary"><?php echo $tl["general"]["g10"];?></button>
	...
	<div class="col-md-6">
		...
		<button type="submit" name="stuffR" class="btn btn-primary"><?php echo $tl["general"]["g10"];?></button>
...
<div class="row">
	...
	<div class="col-md-12">
		...
		<form method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>" enctype="multipart/form-data">
			...
			<button type="submit" name="email_passR" class="btn btn-primary"><?php echo $tl["general"]["g10"];?></button>
		</form>
