...
<tr>
	...
	<td><input type="text" name="jak_estship" class="form-control" value="<?php if (isset($_REQUEST["jak_estship"])) echo $_REQUEST["jak_estship"]; ?>" /></td>
</tr>
<tr>
...
<tr>
	...
	<td>
	<div class="form-group<?php if (isset($errors["e3"])) echo " has-error";?>">
	<input type="text" name="jak_handling" class="form-control" value="<?php if (isset($_REQUEST["jak_handling"])) echo $_REQUEST["jak_handling"]; ?>" />
	</div></td>
</tr>
<tr>
	...
	<div class="col-md-6">
	<div class="input-group">
	  <input type="text" name="jak_weightto" class="form-control" value="<?php if (isset($_REQUEST["jak_weightto"])) echo $_REQUEST["jak_weightto"]; ?>">
	  <span class="input-group-addon"><?php echo $tlec["shop"]["m70"];?></span>
	</div>
	</div>
	</div></td>
