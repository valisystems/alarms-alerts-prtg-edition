...
<div class="row">
	<div class="col-md-12">
		...
		<div class="pull-right">
			...
			<button type="submit" name="refresh" class="btn btn-grey"><i class="fa fa-refresh"></i> <?php echo $tlec["shop"]["m19"];?></button>
	...
	<div class="col-md-12">
		...
		<table class="shopping-cart">
			...
			<tr>
				...
				<td class="actions">
					<a href="<?php echo htmlspecialchars(JAK_rewrite::jakParseurl(JAK_PLUGIN_VAR_ECOMMERCE, 'rc', $v["cartid"]));?>" class="btn btn-xs btn-grey"><i class="fa fa-trash-o"></i></a>
				</td>
			</tr>
	...
	<div class="col-md-3  col-md-offset-0 col-sm-6 col-sm-offset-6">
		<div class="cart-promo-code">
			...
			<div class="input-group">
				...
				<span class="input-group-btn">
					<button class="btn btn-sm btn-grey" type="submit" name="checkC" id="jak_checkC"><?php echo $tlec["shop"]["m62"];?></button>
				</span>
			</div>
