...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="product-img">
			...
			<?php } ?>
			<img class="img-responsive" src="<?php echo $row["previmg"];?>" alt="product thumbnail" id="p_<?php echo $row["id"];?>" />
			<?php if ($row['previmg']) { ?>
			</a>
			<?php } ?>
			</div>
	...
	<div class="col-sm-6 shop-item">
		<h2 class="first-child text-color"><?php echo $PAGE_TITLE;?></h2>
		<p class="price">
		  <?php if ($onsale) { ?>
		  <span class="old"><?php echo $row["price"];?></span>
		  <span class="new"><span class="pprice_<?php echo $row["id"];?>"><?php echo $row["sale"];?></span> <?php echo $jkv["e_currency"];?></span>
		  <?php } else { ?>
		  <span class="new"><span class="pprice_<?php echo $row["id"];?>"><?php echo $row["price"];?></span> <?php echo $jkv["e_currency"];?></span>
		  <?php } ?>
		</p>
		...
		<?php } ?>
		<p><a href="#" class="btn btn-color pull-right" onclick="addlist(<?php echo $row['id'];?>);return false;"><i class="fa fa-shopping-cart"></i> <?php echo $tlec["shop"]["m67"];?></a></p>
