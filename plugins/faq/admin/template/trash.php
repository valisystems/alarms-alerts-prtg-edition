...
<th><button type="submit" name="untrash" id="button_lock" class="btn btn-default btn-xs" onclick="if(!confirm('<?php echo $tlf["faq"]["ap"];?>'))return false;"><i class="fa fa-check"></i></button></th>
