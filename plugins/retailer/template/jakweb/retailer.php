			...
			<div class="zoom-item">
				...
				<div class="zoom-info-fade">
					<ul>
						...
						<li class="read-more">
							<a href="<?php echo $v["parseurl"];?>" class="btn btn-info"><?php echo $tl["general"]["g3"];?></a>
							<?php if (JAK_ASACCESS) { ?>
							<a class="btn btn-default jaktip" href="<?php echo BASE_URL;?>admin/index.php?p=retailer&amp;sp=edit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g"];?>"><i class="fa fa-pencil"></i></a>
							<a class="btn btn-default jaktip quickedit" href="<?php echo BASE_URL;?>admin/index.php?p=retailer&amp;sp=quickedit&amp;id=<?php echo $v["id"];?>" title="<?php echo $tl["general"]["g176"];?>"><i class="fa fa-edit"></i></a>
							<?php } ?>
						</li>
					</ul>
				</div>
