...
<th><button type="submit" name="untrash" id="button_lock" class="btn btn-default btn-xs" onclick="if(!confirm('<?php echo $tlre["retailer"]["ap"];?>'))return false;"><i class="fa fa-thumbs-o-up"></i></button></th>
...
<i title="<?php echo $tl["icons"]["i18"];?>" class="fa fa-thumbs-o-up"></i>
